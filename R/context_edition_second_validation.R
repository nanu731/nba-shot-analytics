...
fit_diagnostics <- bind_rows(m0$diagnostics, m1$diagnostics) |> mutate(fit_reused = FALSE, refit_count = 1L, fit_sha256 = if_else(model_id == "M0", m0$fit_sha256, m1$fit_sha256)) |> arrange(model_id)
